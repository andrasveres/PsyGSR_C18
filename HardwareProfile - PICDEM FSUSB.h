...
#define HARDWARE_PROFILE_PICDEM_FSUSB_H
    ...
    #define tris_pulse_led TRISAbits.TRISA5 
    #define pulse_led LATAbits.LATA5
    //#define pulse_led PORTAbits.RA5
    ...
    // ANDRIS: Multiple define, other in xlcd
    ...
    #define mInitSwitch()      TRISBbits.TRISB5=1; 
    //#define mInitSwitch3()      TRISBbits.TRISB5=1;
    //#define sw2                 PORTBbits.RB4
    #define sw                 PORTBbits.RB5

    //#define TEST_LED_TRIS TRISAbits.TRISA5
    //#define TEST_LED LATAbits.LATA5

    
    /** POT ************************************************************/
    // #define mInitPOT()          {ADCON0=0x01;}
